						...
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr
									...
									<s:iterator var="p" value="#request.pageBean.list" status="status">
									...
									<td align="center" width="18%" colspan="8">
										...
										<s:if test="#request.pageBean.page != 1">
											...
											<a href="${ pageContext.request.contextPath }/product_adminFindAll.action?page=<s:property value="#request.pageBean.page-1"/>">上一页</a> |
										</s:if>
										<s:if test="#request.pageBean.page != #request.pageBean.totalPage">
											<a href="${ pageContext.request.contextPath }/product_adminFindAll.action?page=<s:property value="#request.pageBean.page+1"/>">下一页</a> |
											<a href="${ pageContext.request.contextPath }/product_adminFindAll.action?page=<s:property value="#request.pageBean.totalPage"/>">尾页</a>
										</s:if>
									</td>
