...
public class MailUtils {
	...
	public static void sendMail(String to,String code) throws AddressException, MessagingException {
		...
		message.setContent("<h1>来自ONLINE STORE的官网激活邮件</h1><h3>请点击下方链接来激活您的账号，若不是您本人操作请忽略该邮件</h3><h5><a href='http://localhost:8080/OnlineStore/user_active.action?code="+code+"'>http://localhost:8080/OnlineStore/user_active.action?code="+code+"</a></h5>", "text/html;charset=UTF-8");
